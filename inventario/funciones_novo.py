...
from funciones import cargar_datos_excel
...
def inventario_sirena (ruta_archivo = None):
  return cargar_datos_excel (sheet_name= "inventario", columnas= ["VENECIANA", "TIPO VENECIANA" , "CANTIDAD VENECIANA"], ruta_archivo= ruta_archivo)

def inventario_oleica (ruta_archivo = None):
  datos = cargar_datos_excel(sheet_name= "inventario", columnas= ["OLEICA", "TIPO OLEICA", "CANTIDAD OLEICA"], ruta_archivo= ruta_archivo)
...
def inventario_giralda (ruta_archivo = None):
  datos = cargar_datos_excel(sheet_name= "inventario", columnas= ["GIRALDA", "TIPO GIRALDA", "CANTIDAD GIRALDA"], ruta_archivo= ruta_archivo)
...
def contar_veneciana (ruta_archivo = None):
  datos_veneciana = cargar_datos_excel(sheet_name="inventario", columnas=["VENECIANA"], ruta_archivo= ruta_archivo)
...
def contar_oleica(ruta_archivo = None):
  datos_oleica= cargar_datos_excel(sheet_name="inventario", columnas=["OLEICA"], ruta_archivo= ruta_archivo)
...
def contar_giralda (ruta_archivo = None):
  datos_giralda = cargar_datos_excel(sheet_name="inventario", columnas=["GIRALDA"], ruta_archivo= ruta_archivo)
...
def sumar_stock_novo (ruta_archivo = None):
  ...
  datos_veneciana = cargar_datos_excel(sheet_name= "inventario", columnas=["CANTIDAD VENECIANA"], ruta_archivo=ruta_archivo)
  total += sum([fila[0] for fila in datos_veneciana if isinstance(fila[0], (int, float))and pd.notna(fila[0])])

  datos_oleica = cargar_datos_excel(sheet_name= "inventario", columnas=["CANTIDAD OLEICA"], ruta_archivo=ruta_archivo)
  total += sum([fila[0] for fila in datos_oleica if isinstance(fila[0], (int, float))and pd.notna(fila[0])])

  datos_giralda = cargar_datos_excel(sheet_name= "inventario", columnas=["CANTIDAD GIRALDA"], ruta_archivo=ruta_archivo)
...
def low_stock_novo (ruta_archivo = None, umbral = 5):
  ...
  for columna in columnas:
    cantidades = cargar_datos_excel("inventario" , columna, ruta_archivo)
